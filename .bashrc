...
#export DIRK="8998" 
alias c='clear'
alias w='cd /home/siagrawal/source/yocto_3.1.6/'
alias ww='w;cd src'
...
alias grok='cd ~/Downloads/grokit/;./grokit --action=start; cd -;'
alias p='pwd'
alias sup='svn up '
alias tt='TARGET=x86 make -f x86.mk ap_data && sudo builds/x86/ap_data -oft0'
